...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Login: Success, redirecting to:', user.role === 'nurse' ? '/nurse' : '/hospital');
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="appearance-none relative block w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
